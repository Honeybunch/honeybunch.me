...
![windows terminal in windows 11 with poorly drawn red hearts](./hobby-windows-dev-env/mynewbestfriend.png)
...
![scoop installed](./hobby-windows-dev-env/scooped.png)
...
![cmder booted](./hobby-windows-dev-env/booted.png)
...
![some unix tools](./hobby-windows-dev-env/power.png)
